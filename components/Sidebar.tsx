...
import { 
  ...
  UtensilsCrossed, FileSearch, TrendingUp, Landmark, ClipboardList, ShieldCheck,
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, isOpen, setIsOpen, currentUser, onLogout }) => {
  ...
  const menuItems = [
    ...
    { id: 'CRM', label: 'CRM', icon: ShieldCheck },
    ...
    { id: 'PURCHASES_GROUP', label: 'Compras', icon: ShoppingBag, hasSubmenu: true,
      children: [
        ...
        { id: 'PURCHASES', label: 'Documentos de Compara' },
    ...
    { id: 'ACCOUNTING_GROUP', label: 'Contabilidade', icon: Calculator, hasSubmenu: true,
      children: [
        ...
        { id: 'ACCOUNTING_WITHHOLDING_MAPS', label: 'Mapas de Retenção', icon: Landmark },
    ...
    { id: 'HR_GROUP', label: 'Recursos Humanos', icon: Users, hasSubmenu: true, 
      children: [
        ...
        { id: 'HR_INSS_LIST', label: 'Trabalhador INSS' },
        { id: 'HR_SITUACAO_LABORAL', label: 'Situação Laboral', icon: ClipboardList },
        { id: 'HR_PERFORMANCE', label: 'Análise de Desempenho', icon: BarChart3 },
        { id: 'HR_PRINT_CARDS', label: 'Imprimir Cartões Funcionário', icon: IdCard },
  ...
  return (
    <>
      ...
      <div className={`
        ...
        flex flex-col h-full shadow-2xl border-r border-slate-800 font-sans lg:static
      `}>
