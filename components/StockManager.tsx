      ...
      return (
          <div className="bg-white border border-slate-300 rounded shadow-lg overflow-hidden animate-in zoom-in-95">
              <div className="bg-slate-900 text-white p-4 flex justify-between items-center">
                  <h3 className="font-black text-sm uppercase flex items-center gap-2"><Monitor size={18} className="text-blue-400"/> Painel de Monitorização: Produtos</h3>
